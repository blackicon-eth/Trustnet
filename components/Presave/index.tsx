...
import { ContextType, useMiniAppContext } from "@/lib/hooks/use-miniapp-context";
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center p-4">
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-muted-foreground">Presave to be added to the waitlist</p>
        <button
